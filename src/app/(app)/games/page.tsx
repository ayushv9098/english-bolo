          ...
          {loading ? (
            ...
            games.map((game, index) => (
              <Link key={index} href={game.href} className="group">
                <Card className={cn(
                  "p-4 flex items-center gap-4 active:scale-[0.98] transition-all border-[1.5px] shadow-sm hover:shadow-md",
                  game.theme,
                  game.border
                )}>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[13px] font-bold text-muted leading-snug line-clamp-1">
                      {game.description}
                    </p>
                  </div>
